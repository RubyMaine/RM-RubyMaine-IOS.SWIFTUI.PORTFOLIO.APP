...
let menuData = [
   Menu(title: "Мой аккайнт", icon: "person.crop.circle"),
   Menu(title: "Мой настройки", icon: "gear"),
   Menu(title: "Способ оплаты", icon: "creditcard"),
   Menu(title: "Мои группы", icon: "person.2"),
   Menu(title: "Выйти из системы", icon: "arrow.uturn.down")
]
